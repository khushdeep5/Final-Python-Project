...
class DoctorManager:
    ...
    def format_dr_info(self, doctor):
       return f"{doctor._doctor_id}_{doctor._name}_{doctor._specialization}_{doctor._working_time}_{doctor._qualification}_{doctor.room_number}"
...
class Management:
    ...
    def patients_menu(self):
        while True:
            ...
            if choice == '1':
                self.patient_manager.display_patient_list()
            elif choice == '2':
